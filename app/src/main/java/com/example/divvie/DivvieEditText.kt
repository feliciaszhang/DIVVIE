...
class DivvieEditText(context: Context, attributeSet: AttributeSet?, defStyleAttr: Int, defStyleRes: Int)
    ...
    private var gradient = LinearGradient(0f, 0f, 0f, 0f, 0, 0, Shader.TileMode.CLAMP)
    ...
    override fun onScrollChanged(horiz: Int, vert: Int, oldHoriz: Int, oldVert: Int) {
        ...
        val leftPercent = if (horizontal < rightPercent) { horizontal } else { rightPercent } // gradually increase left gradient until a set length
        ...
        gradient = LinearGradient(0f, 0f, rightWidth.toFloat(), 0f,
